    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)//FIGURE OUT HOW TO ADD PHOTOS OF EACH POKEMON TO DB AT SOME POINT
        {
            ...
            modelBuilder.Entity<Pokemon>().HasData(
                ...
                new Pokemon {Id = 4, Name = "Captain Sushi", PokemonType = "Galarian Meowth", Age = 10, Description = "This Pokémon has been choosen! Best of luck, buddy!", IsAvailable = false },
                ...
                new Pokemon { Id = 7, Name = "Oliver", PokemonType = "Carnivine", Age = 13, Description = "This Pokémon has been choosen! Best of luck, buddy!", IsAvailable = false},
                new Pokemon { Id = 8, Name = "Lilo", PokemonType = "Flabébé", Age = 3, Description = "This Pokémon has been choosen! Best of luck, buddy!", IsAvailable = false},
