    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)//ADD PHOTOS OF EACH POKEMON TO DB AT SOME POINT
        {
            ...
            modelBuilder.Entity<Pokemon>().HasData(
                new Pokemon {Id = 1, Name = "Molla", PokemonType = "Haunter", BattleType = "Poison/Ghost", Age = 307, Description = "Super sweet and a bit shy. Molla was found still in her ball after her owner had passed away, and now hopes to find a new playmate. She enjoys night walks and hide-and-seek", IsAvailable = true, ImageOfPokemon = "/images/Placeholder.png" },
                ...
                new Pokemon {Id = 6, Name = "Chompee", PokemonType = "Mareanie", BattleType = "Poison/Water", Age = 5, Description = "Found tangled in beach debris. When she refused to return to the sea, she was brought to us to find a home. Chompee is incredibly affectionate and adores physical contact. Just watch out for those spikes, as they may hurt.", IsAvailable = true, ImageOfPokemon = "/images/Placeholder.png" },
                ...
                new Pokemon { Id = 10, Name = "Theodore", PokemonType = "Phantump", BattleType = "Grass/Ghost", Age = 102, Description = "Found in an abandoned house, Theodore was brought into our care after it was determined he could not provide for himself in the wild. While he may seem incredibly shy and closed off at first, Theodore is actually very sweet once you get to know him.", IsAvailable = true, ImageOfPokemon = "/images/Placeholder.png" },

                new Pokemon { Id = 11, Name = "Oakley", PokemonType = "Espurr", BattleType = "Psychic", Age = 4, Description = "Dropped off at our center as an egg, Oakley is fairly mild mannered and prefers to be alone most days. However, despite not wanting to play with the other Pokémon, Oakley will often be found close by to an employee, most often just watching as we go about our work.", IsAvailable = true, ImageOfPokemon = "/images/Placeholder.png" },

                new Pokemon { Id = 12, Name = "Jade", PokemonType = "Kirlia", BattleType = "Psychic/Fairy", Age = 13, Description = "This Pokémon is currently still in rehabilitation. Please be patient with her!", IsAvailable = false, ImageOfPokemon = "/images/Placeholder.png" }
                );
